...
const TrustBadges = () => {
 ...
 className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 lg:px-6 py-2 group"
 >
 <div className={`flex-shrink-0 w-11 h-11 flex items-center justify-center rounded-2xl ${iconBg} ${iconColor} transition-transform duration-300 group-hover:scale-110`}>
 ...
 <p className="text-[11px] text-primary/70 mt-1">{subtitle}</p>
