...
const Loader = ({ size = 'md', text = '', fullPage = false }) => {
 ...
 <div className={`${sizes[size]} rounded-full border-border/70`} style={{ border: 'inherit' }} />
 <motion.div
...
export const SkeletonCard = () => (
 <div className="flex flex-col h-full bg-surface-white rounded-[1.25rem] overflow-hidden border border-border/70">
 ...
 <div className="mt-auto pt-4 border-t border-border/70 flex justify-between items-end">
...
export const SkeletonOrderItem = () => (
 ...
 {/* Header */}
 <div className="bg-surface/50 px-6 py-5 flex justify-between items-center border-b border-border/60">
