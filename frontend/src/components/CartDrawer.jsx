                      ...
                      >
                        ...
                        <Link to={`/product/${item._id}`} onClick={closeCart} className="flex-shrink-0 w-24 h-28 bg-surface rounded-xl overflow-hidden block relative z-10 border border-secondary/10">
                          <img
                            ...
                            alt={item.name}
                            loading="lazy"
                            className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 ease-[0.25,1,0.25,1]"
                          />
                        </Link>
                        ...
                        <button
                          ...
                          className="absolute top-3 right-3 p-1.5 rounded-full text-primary/30 hover:text-error hover:bg-error/10 transition-all flex-shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-error z-20 opacity-0 group-hover:opacity-100"
