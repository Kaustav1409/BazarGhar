 ...
 */
 ...
 const t5 = setTimeout(() => onFinish(), 3600); // Wait full 800ms for fade out
 ...
 style={{
 background: 'radial-gradient(ellipse at 50% 50%, rgba(163, 133, 96, 0.15) 0%, rgba(163, 133, 96, 0.05) 45%, transparent 75%)',
 }}
 aria-hidden="true"
 />
 ...
 >
 {/* Text render */}
 <div className="font-brand font-extrabold text-[5.5vw] md:text-[4.5rem] lg:text-[6.5rem] tracking-tight leading-none text-white drop-shadow-[0_4px_24px_rgba(255,255,255,0.1)]">
 {letters.map((char, index) => (
 <span 
 key={index} 
 className={index >= 5 ? 'text-secondary' : 'text-white'}
 style={{ 
 ...
 className="absolute top-0 bottom-0 z-20 w-[20%] bg-gradient-to-r from-transparent via-[#F5F0E6]/50 to-transparent mix-blend-overlay skew-x-[-20deg]"
 />
)}
 </motion.div>
)}
 ...
 className="font-body text-[10px] md:text-[11px] tracking-[0.4em] uppercase text-white/80 font-medium drop-shadow-sm"
 >
