...
const Home = () => {
 ...
 transition={{ duration: 1, delay: 0.2, ease: [0.25, 1, 0.25, 1] }}
 >
 <p className="text-[11px] font-medium font-body tracking-[0.4em] text-[#F8F5F0] uppercase mb-6">
 ...
 ═══════════════════════════════════════════════ */}
 <section id="featured"className="py-32 lg:py-48 px-6 lg:px-10 max-w-[1440px] mx-auto scroll-mt-20">
 ...
 className="md:col-span-7 h-[450px] md:h-[600px] lg:h-[800px] group relative overflow-hidden lg:"
 >
 <Link to="/products?category=Fashion"className="block w-full h-full">
 <img src={fashionImg} alt="Fashion Edit"loading="lazy"decoding="async"className="w-full h-full object-cover transition-transform duration-[1.5s] ease-luxury group-hover:scale-[1.02]"onError={(e) => { e.target.onerror = null; e.target.src = premiumFallback; }} />
 <div className="absolute inset-0 bg-surface/40 group-hover:bg-surface/60 transition-colors duration-700"/>
 <div className="absolute inset-x-0 bottom-0 p-10 lg:p-16">
 <p className="label-editorial mb-4">01 — The Wardrobe</p>
 <h3 className="font-heading text-4xl lg:text-5xl font-bold text-primary mb-6">Minimalist Fashion.</h3>
 <span className="text-primary text-[11px] font-semibold font-body tracking-[0.2em] uppercase border-b border-primary pb-1">Shop The Edit</span>
 </div>
 </Link>
 </motion.div>
 ...
 className="h-[350px] md:h-[400px] lg:h-[450px] group relative overflow-hidden lg:"
 >
 <Link to="/products?category=Electronics"className="block w-full h-full">
 <img src={techImg} alt="Tech Edit"loading="lazy"decoding="async"className="w-full h-full object-cover transition-transform duration-[1.5s] ease-luxury group-hover:scale-[1.02]"/>
 <div className="absolute inset-0 bg-surface/40 group-hover:bg-surface/60 transition-colors duration-700"/>
 <div className="absolute inset-x-0 bottom-0 p-8 lg:p-10">
 <p className="label-editorial mb-3">02 — Productivity</p>
 <h3 className="font-heading text-3xl font-bold text-primary mb-4">Tech Essentials.</h3>
 <span className="text-primary text-[10px] font-semibold font-body tracking-[0.2em] uppercase border-b border-primary pb-1">Shop Now</span>
 </div>
 </Link>
 </motion.div>
 ...
 whileInView={{ opacity: 1, y: 0 }}
 viewport={{ once: true, margin: '-100px' }}
 transition={{ duration: 0.8, delay: 0.4, ease: [0.25, 1, 0.25, 1] }}
 className="flex-1 min-h-[300px] md:min-h-[350px] group relative overflow-hidden bg-surface-secondary flex items-center justify-center p-10 text-center lg:"
 >
 <Link to="/products?category=Furniture"className="block w-full">
 <p className="label-editorial text-secondary mb-6">03 — Interiors</p>
 ...
 <h2 className="font-heading text-4xl lg:text-5xl font-bold text-primary tracking-tight">Top Collections</h2>
 </div>
 <Link to="/categories"className="text-[11px] font-semibold text-primary tracking-[0.2em] uppercase hover:text-secondary transition-colors border-b border-primary hover:border-secondary pb-1">
 View All Categories
 </Link>
 </div>
 ...
 BEST SELLERS
 ═══════════════════════════════════════════════ */}
 <section className="py-32 lg:py-48 px-6 lg:px-10 max-w-[1440px] mx-auto">
 <div className="text-center mb-20 lg:mb-32">
 ...
 ═══════════════════════════════════════════════ */}
 <section className="py-24 lg:py-32 bg-surface-white text-primary">
 <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
 ...
 className="text-left"
 >
 <div className="w-12 h-12 border border-primary/40 flex items-center justify-center text-primary mb-6">
 <svg className="w-5 h-5"fill="none"viewBox="0 0 24 24"strokeWidth={1.5} stroke="currentColor">
 <path strokeLinecap="round"strokeLinejoin="round"d={feature.icon} />
 </svg>
 </div>
 <h3 className="font-heading text-xl font-bold mb-3">{feature.title}</h3>
 <p className="text-primary/70 text-[14px] leading-relaxed font-medium">{feature.desc}</p>
 </motion.div>
))}
 </div>
 </div>
