...
const About = () => {
 return (
 <div className="min-h-screen bg-surface text-primary"id="main-content">
 <SEO title="About Us"description="Learn more about BazarGhar's commitment to quality."/>
 
 {/* ── Hero Section ─────────────────────────────── */}
 <section className="pt-32 lg:pt-48 pb-20 px-6 lg:px-10 max-w-[1600px] mx-auto border-b border-border/60">
 ...
 >
 <p className="font-body text-[11px] font-medium tracking-[0.4em] text-primary/60 uppercase mb-6">
 Our Philosophy
 </p>
 <h1 className="font-heading text-5xl lg:text-7xl font-bold text-primary leading-[1.05] tracking-tighter mb-8 text-balance">
 Elevating everyday living through exceptional quality and design.
 </h1>
 <p className="font-body text-lg text-primary/70 max-w-2xl leading-relaxed mb-10 font-medium">
 ...
 <Link to="/products"className="inline-block border border-border text-primary hover:bg-primary hover:text-surface-white transition-colors duration-300 px-10 py-4 text-[11px] font-body font-semibold tracking-[0.2em] uppercase rounded-full">
 Explore Collections
 </Link>
 </motion.div>
 <motion.div 
 ...
 <img 
 src={heroBannerImg}
 alt="BazarGhar Premium Experience"
 ...
 <h2 className="font-heading text-3xl lg:text-4xl font-bold text-primary tracking-tight mb-6">
 The BazarGhar Promise
 </h2>
 <div className="w-12 h-[1px] bg-brand/30 mx-auto mb-6"/>
 <p className="font-body text-primary/70 text-base leading-relaxed font-medium">
 ...
 className="flex flex-col border border-border/60 p-10 hover:border-brand/40 transition-colors duration-500 bg-surface-secondary/20 rounded-[2rem]"
 >
 <div className="w-14 h-14 border border-primary/40 flex items-center justify-center text-primary mb-8 rounded-full">
 <svg className="w-6 h-6"fill="none"viewBox="0 0 24 24"strokeWidth={1.5} stroke="currentColor">
 <path strokeLinecap="round"strokeLinejoin="round"d={feature.icon} />
 </svg>
 </div>
 <h3 className="font-heading text-xl font-bold text-primary mb-4">{feature.title}</h3>
 <p className="font-body text-primary/60 text-[14px] leading-relaxed font-medium">{feature.desc}</p>
 </motion.div>
))}
 </div>
 </section>
