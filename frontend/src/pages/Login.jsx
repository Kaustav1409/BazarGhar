      ...
      >
        <div className="bg-surface-white/5 backdrop-blur-xl border border-surface-white/10 p-8 sm:p-12 rounded-[2rem] shadow-[0_0_40px_-10px_rgba(0,0,0,0.5)]">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="font-heading text-2xl font-bold text-surface-white mt-6 mb-2">Welcome back</h1>
            <p className="text-surface-white/50 text-[13px] font-medium">Enter your credentials to continue</p>
          </div>

          {/* Social Sign In */}
          <button
            className="w-full flex items-center justify-center gap-3 bg-surface-white/5 hover:bg-surface-white/10 border border-surface-white/10 text-surface-white py-3.5 rounded-2xl transition-all duration-300 font-medium text-[13px] mb-8 group"
            type="button"
          ...
          <div className="relative flex items-center gap-4 mb-8">
            <div className="flex-1 h-px bg-surface-white/10" aria-hidden="true" />
            <span className="text-[10px] uppercase tracking-widest text-surface-white/30 font-bold">Or Email</span>
            <div className="flex-1 h-px bg-surface-white/10" aria-hidden="true" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            <div className="flex justify-end pb-2">
              <a href="#" className="text-[11px] font-bold tracking-widest text-surface-white/50 hover:text-surface-white transition-colors uppercase">Forgot Password?</a>
            </div>
            ...
            <motion.button
              ...
              id="login-submit-btn"
              className={`w-full bg-surface-white text-primary py-4 rounded-2xl text-[12px] font-bold tracking-[0.2em] uppercase transition-all ${loading ? 'opacity-80 cursor-not-allowed' : 'hover:bg-surface-white/90 shadow-[0_0_20px_rgba(255,255,255,0.2)]'}`}
              aria-busy={loading}
            >
              {loading ? (
          ...
          <p className="text-center mt-8 text-[12px] font-medium text-surface-white/40">
            ...
            <Link to="/register" className="text-surface-white hover:text-surface-white/80 transition-colors font-bold border-b border-surface-white/30 pb-0.5">Create one</Link>
          </p>
        </div>
        
        {/* Decorative elements */}
        <div className="absolute top-1/2 left-0 -translate-x-12 w-24 h-px bg-gradient-to-r from-transparent to-surface-white/20" />
        <div className="absolute top-1/2 right-0 translate-x-12 w-24 h-px bg-gradient-to-l from-transparent to-surface-white/20" />
      </motion.div>
    </div>
  );
};
