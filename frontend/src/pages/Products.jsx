...
const Products = () => {
 ...
 className="text-[10px] font-bold tracking-[0.25em] text-primary/60 uppercase mb-4"
 >
 Discover Collection
 </motion.p>
 <motion.h1 
 ...
 role="search"
 >
 <div className="absolute left-6 top-1/2 -translate-y-1/2 text-primary/70 group-focus-within:text-primary/60 transition-colors pointer-events-none">
 ...
 className="input-base !py-4 !pl-14 !pr-32 !bg-surface-secondary shadow-inner-soft"
 ...
 className="p-2 text-primary/70 hover:text-primary/70 transition-colors rounded-full"
 ...
 <button type="submit"className="btn-primary !py-2.5 !px-5 shadow-sm">
 Search
 </button>
 </div>
 </motion.form>
 ...
 animate={{ opacity: 1 }}
 exit={{ opacity: 0 }}
 className="flex items-center gap-4 text-xs font-medium text-primary/70"
 >
 ...
 <div className="flex items-center justify-between lg:justify-end mb-8 border-b border-border/60 pb-4">
 <button
 ...
 <span className="text-[11px] font-bold tracking-[0.1em] text-primary/60 uppercase mr-3 hidden sm:block">Sort By</span>
 ...
 >
 <span className="label-editorial text-primary/60">Active</span>
 {category !== 'All' && (
 ...
 {category}
 <button onClick={() => updateParam('category', '')} className="text-primary/60 hover:text-error transition-colors">
 ...
 <span className="flex items-center gap-2 px-4 py-1.5 bg-surface text-primary border border-border/60 text-[11px] font-bold rounded-full shadow-sm">
 ₹{minPrice || '0'} – ₹{maxPrice || '∞'}
 <button onClick={() => { setLocalMin(''); setLocalMax(''); const p = Object.fromEntries(searchParams.entries()); delete p.minPrice; delete p.maxPrice; setSearchParams(p); }} className="text-primary/60 hover:text-error transition-colors">
 <svg className="w-3.5 h-3.5"fill="none"viewBox="0 0 24 24"strokeWidth={2} stroke="currentColor"><path strokeLinecap="round"strokeLinejoin="round"d="M6 18L18 6M6 6l12 12"/></svg>
 </button>
 </span>
)}
 ...
 className="text-[11px] text-primary/60 hover:text-error transition-colors font-semibold ml-2 underline underline-offset-4"
 >
 Clear all
 </button>
 </motion.div>
 ...
 <h2 className="text-[10px] font-bold tracking-[0.25em] text-primary/60 uppercase mb-6">Collections</h2>
 ...
 category === cat ? 'text-primary' : 'text-primary/70 hover:text-primary/80'
 }`}
 >
 <span>{cat}</span>
 {category === cat && (
 ...
 <h2 className="text-[10px] font-bold tracking-[0.25em] text-primary/60 uppercase mb-6 pt-8 border-t border-border/60">Refine Price</h2>
 <div className="space-y-4">
 <div className="relative">
 <span className="absolute left-4 top-1/2 -translate-y-1/2 text-primary/60 text-[13px] font-medium">₹</span>
 <input
 type="number"
 placeholder="Min"
 value={localMin}
 ...
 <svg className="w-8 h-8 text-primary/70"fill="none"viewBox="0 0 24 24"stroke="currentColor"strokeWidth={1}>
 <path strokeLinecap="round"strokeLinejoin="round"d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 15.803a7.5 7.5 0 0010.607 0z"/>
 </svg>
 </div>
 <h3 className="font-heading text-2xl font-bold text-primary mb-3">No curations found</h3>
 <p className="text-[14px] text-primary/70 mb-8 max-w-sm leading-relaxed font-medium">
 We couldn't find any products matching your current filters. Try adjusting your search criteria.
 </p>
 <button onClick={clearFilters} className="btn-primary shadow-soft">
 Reset Catalogue
 </button>
 </motion.div>
) : (
 ...
 className="fixed right-0 top-0 bottom-0 z-50 w-[85vw] max-w-sm bg-surface-dark shadow-[0_0_40px_rgba(0,0,0,0.5)] overflow-y-auto"
 >
 <div className="flex items-center justify-between px-6 py-6 border-b border-border/60 sticky top-0 bg-surface-dark/90 backdrop-blur-md z-10">
 <h2 className="font-heading text-lg font-bold text-primary">Filters</h2>
 <button
 onClick={() => setSidebarOpen(false)}
 className="p-2 -mr-2 rounded-full text-primary/70 hover:text-primary hover:bg-surface-secondary transition-all"
 >
 <svg className="w-5 h-5"fill="none"viewBox="0 0 24 24"strokeWidth={1.5} stroke="currentColor">
 <path strokeLinecap="round"strokeLinejoin="round"d="M6 18L18 6M6 6l12 12"/>
 </svg>
 ...
 <div className="p-6">
 <h3 className="text-[10px] font-bold tracking-[0.25em] text-primary/60 uppercase mb-6">Collections</h3>
 ...
 <h3 className="text-[10px] font-bold tracking-[0.25em] text-primary/60 uppercase mb-6">Price Range</h3>
 <div className="space-y-4">
 <div className="flex gap-4">
 <div className="relative flex-1">
 <span className="absolute left-4 top-1/2 -translate-y-1/2 text-primary/60 text-sm">₹</span>
 ...
 <button onClick={() => { applyPriceFilter(); setSidebarOpen(false); }} className="w-full py-4 bg-primary text-surface-dark text-[11px] font-bold tracking-[0.1em] uppercase rounded-xl hover:bg-surface-secondary hover:text-primary transition-colors shadow-soft">
 Apply Limits
 </button>
 </div>
 </div>
 ...
 className="w-full mt-6 py-4 text-[12px] font-semibold text-primary/70 hover:text-error transition-colors"
 >
 Reset Everything
 </button>
)}
