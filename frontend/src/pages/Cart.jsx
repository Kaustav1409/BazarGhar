...
const Cart = () => {
 ...
 <p className="text-[13px] text-primary/70 font-medium tracking-wide mt-4 uppercase">
 ...
 className="flex flex-col sm:flex-row gap-8 pb-8 border-b border-border/60 group relative"
 >
 {/* Image */}
 <Link to={`/product/${item._id}`} className="shrink-0 relative">
 <div className="w-32 h-40 sm:w-40 sm:h-48 rounded-[2rem] overflow-hidden bg-surface-white border border-border shadow-soft group-hover:border-primary/40 transition-colors">
 <img
 ...
 className="w-12 h-full flex items-center justify-center text-xl text-primary/60 hover:text-primary transition-colors focus:outline-none"
 ...
 className="group/remove flex items-center gap-2 px-3 py-2 text-primary/60 hover:text-error transition-colors"
 ...
 className="w-full bg-transparent px-4 py-4 text-[13px] text-primary font-medium focus:outline-none placeholder:text-primary/70 uppercase"
 />
 <button
 onClick={applyCoupon}
 ...
 <button onClick={() => { setAppliedCoupon(false); setCoupon(''); }} className="text-primary/60 hover:text-error transition-colors"aria-label="Remove coupon">
